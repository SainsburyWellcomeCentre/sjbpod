function State_Change_Two_Alternative_Choice_GUIParameters()
    ...
    S.GUIPanels.General = {'SoundAmplitude','LEDIntensity','RewardAmount',...
        'ResponseTime','CenterPortDuration','PunishDelay','TrainingLevel',...
    ...
    % Fields
    S.GUIPanels.Specifics = {'RecordingSide', 'OriginalSoundsBlockLength', 'Contingency','ContingencyBlockLength',...
        'Muscimol','RewardProb','RewardChange','RewardChangeBlockLength'};
    S.GUI.RecordingSide = 1; % Default is Left
    S.GUIMeta.RecordingSide.Style = 'popupmenu'; % the GUIMeta field is used by the ParameterGUI plugin to customize UI objects.
    S.GUIMeta.RecordingSide.String = {'Left', 'Right'};
    S.GUI.OriginalSoundsBlockLength = 150;
    ...
    S.GUIMeta.RewardChange.String = {'No', '3x Block Switch'};
