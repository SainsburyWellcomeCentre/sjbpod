function Two_Alternative_Choice_Tones_On_ReturnGUIParameters()
    ...
    S.GUI.BiasCorrection = 0; % Default is off
    ...
    %% New type trials tab
    S.GUITabs.NewTypeTrials = {'NewTypeTrials'};
    S.GUIPanels.NewTypeTrials = {'ProportionNewTrials', 'NewTypeTrialsMeanSoundDelay', 'NewTypeTrialsSoundDuration', 'FiberSideForNewTrials'};
    S.GUI.ProportionNewTrials = 0.5;
    S.GUI.NewTypeTrialsMeanSoundDelay = 0.02;
    S.GUI.NewTypeTrialsSoundDuration = 0.5;
    S.GUI.FiberSideForNewTrials = 1;
    S.GUIMeta.FiberSideForNewTrials.Style = 'popupmenu';
    S.GUIMeta.FiberSideForNewTrials.String = {'Left', 'Right'};
    ...
    S.GUIMeta.Inference.String = {'No', 'Simple_WN', 'Simple_Click', 'Dual', 'Silence'}; % Dual can be sequential or simultaneous
    % WN 
    S.GUI.WNOnset = 50; % Onset (trial) of WN
