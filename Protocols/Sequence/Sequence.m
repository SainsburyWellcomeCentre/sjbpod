...
%% ADAPTED FOR 5 POKE SEQUENCE 31/10/19 EJT
...
for currentTrial = 1:BpodSystem.Data.MaxTrials
    ...
    if ~isempty(fieldnames(RawEvents)) % If trial data was returned
        ...
        BpodSystem.Data.SessionVariables.ItermediateRewardAmount.Port4(currentTrial) = BpodSystem.Data.sma_vars.SessionVariable_IRA4;
        
        if currentTrial == 1
            UpdateOnlinePlotFast(BpodSystem.Data,BpodSystem.GUIData.SubjectName,TrialTypes(currentTrial),'Init',MultiFigureEJT); %update online plot
        else
            UpdateOnlinePlotFast(BpodSystem.Data,BpodSystem.GUIData.SubjectName,TrialTypes(currentTrial),'Update',MultiFigureEJT); %update online plot
        end    
...
function [sma, S] = PrepareStateMachine(S, TrialTypes, currentTrial, currentTrialEvents)
    ...
    if TrialTypes(currentTrial) == 1
        Reward_Valve_time = R(S.GUI.Sequence_1(5));
    elseif TrialTypes(currentTrial) == 2
        Reward_Valve_time = R(S.GUI.Sequence_2(5));
    elseif TrialTypes(currentTrial) == 3
        Reward_Valve_time = R(S.GUI.Sequence_3(5));
    else
        disp('error, trial type not recognised')
        return
    end
    ...
    switch S.GUI.TrainingLevel
        case {1}
            ...
            FourthValveTime = IR(str2num(Port_4));
            ...
            BpodSystem.Data.sma_vars.SessionVariable_IRA4 = 0;% not needed so set to zero
        ...
        case {2 5} %diminishing reward
            if currentTrial == 1 && S.GUI.UsePreviousSettings == 1 && S.GUI.TrainingLevel == 2
                ...
                BpodSystem.Data.sma_vars.SessionVariable_IRA4 = BpodSystem.Data.sma_vars.PrevIntermediateRewardAmount4; %set session varaible to GUI setting
            ...
            elseif currentTrial == 1 && S.GUI.TrainingLevel == 2
                ...
                BpodSystem.Data.sma_vars.SessionVariable_IRA4 = S.GUI.IntermediateRewardAmount; %set session varaible to GUI setting
                BpodSystem.Data.sma_vars.DiminishValve = 1; %set first port to be diminished first
            ...
            elseif currentTrial == 1 && S.GUI.TrainingLevel == 5 % set only custom pokes to diminish:
                ...
                if any(BpodSystem.Data.sma_vars.custom_ports == 5)
                    BpodSystem.Data.sma_vars.SessionVariable_IRA5 =S.GUI.IntermediateRewardAmount;
                else
                    BpodSystem.Data.sma_vars.SessionVariable_IRA5 =0;
                end
            ...
            elseif BpodSystem.Data.sma_vars.DiminishValve == 4 && currentTrial > 2 && isnan(BpodSystem.Data.RawEvents.Trial{1, (currentTrial-2)}.States.Reward(1)) == 0
                BpodSystem.Data.sma_vars.SessionVariable_IRA4 = ReduceReward(BpodSystem.Data.sma_vars.SessionVariable_IRA4,S.GUI.CueDevalRate);
                if BpodSystem.Data.sma_vars.SessionVariable_IRA4 == 0
                    BpodSystem.Data.sma_vars.DiminishValve = BpodSystem.Data.sma_vars.DiminishValve+1;
                end
            elseif BpodSystem.Data.sma_vars.DiminishValve > 4
            ...
            if BpodSystem.Data.sma_vars.SessionVariable_IRA4 == 0
                ...
                IR = GetValveTimes(BpodSystem.Data.sma_vars.SessionVariable_IRA4, [1 2 3 4 5 6 7 8]);
                FourthValveTime = IR(str2num(Port_4));
            end
        ...
        case {2 5} % diminishing brightness
            ...
            elseif currentTrial == 1 && S.GUI.TrainingLevel == 5 % if case 5 set dimish LED to start from port 4:
                ...
                if any(BpodSystem.Data.sma_vars.custom_ports == 2)
                    ...
                    BpodSystem.Data.sma_vars.Diminish_LED = 2;
                end
                if any(BpodSystem.Data.sma_vars.custom_ports == 3)
                    BpodSystem.Data.sma_vars.LedIntensity3 = S.GUI.LEDIntensity;
                    BpodSystem.Data.sma_vars.Diminish_LED = 3;
                end
                if any(BpodSystem.Data.sma_vars.custom_ports == 4)
                    BpodSystem.Data.sma_vars.LedIntensity4 = S.GUI.LEDIntensity;
                    BpodSystem.Data.sma_vars.Diminish_LED = 4;
                end
                if any(BpodSystem.Data.sma_vars.custom_ports == 5)
                    BpodSystem.Data.sma_vars.LedIntensity5 = S.GUI.LEDIntensity;
                    BpodSystem.Data.sma_vars.Diminish_LED = 5;
                end

               BpodSystem.Data.sma_vars.Diminish_LED = (BpodSystem.Data.sma_vars.custom_ports(1))-1;
            ...
            elseif BpodSystem.Data.sma_vars.Diminish_LED == 4 && currentTrial > 2 && isnan(BpodSystem.Data.RawEvents.Trial{1, (currentTrial-2)}.States.Reward(1)) == 0
                BpodSystem.Data.sma_vars.LedIntensity5 = BpodSystem.Data.sma_vars.LedIntensity5 * S.GUI.CueDevalRate;
                BpodSystem.Data.sma_vars.LedIntensity5 %leave uncommented
                if BpodSystem.Data.sma_vars.LedIntensity5 < 10 % if the LED gets very small then switch it off
                    BpodSystem.Data.sma_vars.LedIntensity5 = 0;
                    disp('LED5 turned off');
                    BpodSystem.Data.sma_vars.Diminish_LED  = BpodSystem.Data.sma_vars.Diminish_LED + 1;
                    disp(BpodSystem.Data.sma_vars.Diminish_LED)
                end
            end
        case {3} % shaping sound
            if S.GUI.WarmUp == 1 %if the warm up is turned on in the GUI:
                ...
                if  BpodSystem.Data.sma_vars.RewardTrialsCount <= S.GUI.Shaping1_WarmUpEnd && BpodSystem.Data.sma_vars.LedIntensity2 > 10 && currentTrial > 2 && isnan(BpodSystem.Data.RawEvents.Trial{1, (currentTrial-2)}.States.Reward(1)) == 0
                    ...
                    BpodSystem.Data.sma_vars.LedIntensity5 = BpodSystem.Data.sma_vars.LedIntensity5*0.92;
    ...
    switch S.GUI.TrainingLevel
        case {4}
            ...
            Wrong4 = num2str(WrongPorts(str2num(Port_4),0,str2num(Port_1)));
            Wrong5 = num2str(WrongPorts(str2num(Port_5),0,str2num(Port_1)));
        case {6}
            ...
            Wrong4 = num2str(WrongPorts(str2num(Port_4),str2num(Port_3),str2num(Port_1)));
            Wrong5 = num2str(WrongPorts(str2num(Port_5),str2num(Port_4),str2num(Port_1)));
    end
    ...
    switch S.GUI.TrainingLevel
        case {1 2 5} % sounds for each poke, reward can be set to come from any port as well as final port 
            ...
            Fourth_Reward_Output = {'SoftCode', 4, 'ValveState', Valvestate4,'BNC2', OptoCondition4 };
            Final_Reward_Output = {'SoftCode', 4, 'ValveState', Valvestate5};
        case {3 4} %Sounds for every correct poke, reward at end only 
            ...
            Fourth_Reward_Output = {'SoftCode', 4,'BNC2', OptoCondition4 };
            Final_Reward_Output = {'SoftCode', 4, 'ValveState', Valvestate5};
    end
    ...
    switch S.GUI.TrainingLevel
        ...
        case {4} %make it so that any poke = sound but not a state change
            ...
            port4_conditions = {['Port', Port_4, 'In'], 'FourthPokeValve',['Port',Port_1, 'In'], 'InitialPokeValve','Tup', 'Punish',['Port', Wrong4(1), 'In'],'ThirdPokeValve',['Port', Wrong4(2), 'In'],'ThirdPokeValve',['Port', Wrong4(3), 'In'],'ThirdPokeValve',['Port', Wrong4(4), 'In'],'ThirdPokeValve',['Port', Wrong4(5), 'In'],'ThirdPokeValve',['Port', Wrong4(6), 'In'],'ThirdPokeValve'};
            port5_conditions = {['Port', Port_5, 'In'], 'Reward',['Port',Port_1, 'In'], 'InitialPokeValve','Tup', 'Punish',['Port', Wrong5(1), 'In'],'FourthPokeValve',['Port', Wrong5(2), 'In'],'FourthPokeValve',['Port', Wrong5(3), 'In'],'FourthPokeValve',['Port', Wrong5(4), 'In'],'FourthPokeValve',['Port', Wrong5(5), 'In'],'FourthPokeValve',['Port', Wrong5(6), 'In'],'FourthPokeValve'};
    end
