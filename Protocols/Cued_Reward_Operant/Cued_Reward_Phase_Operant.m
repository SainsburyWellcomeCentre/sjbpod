function [trialsNames, trialsMatrix, ezTrialsSeq]=Cued_Reward_Phase_Operant(S,PhaseName)
...
%         1.type, 2.proba,                      3.sound, 4.delay,   5.valve,                6.Outcome      7.Marker        8. OptoStimCue     9. Delay OptoStimCue      10.OptoStimRwd
    ...
    case 'RewardARewardBOmissionC'  % training
        trialsNames={'Cue A Reward', 'Cue A Omission',...
                     'Cue B Reward', 'Cue B Omission',...
                     'Cue C Omission','Uncued Reward',... 
                     'OptoStim at CueA', 'OptoStim at CueB',...
                     'OptoStim at Reward', 'OptoStim at Omission', 'OptosStim Uncued Reward'};
...
%         1.type, 2.proba,                      3.sound, 4.delay,   5.valve,                6.Outcome      7.Marker        8. OptoStimCue     9. Delay OptoStimCue      10.OptoStimRwd
            1,   S.GUI.ProbCueARwd,             1,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,    double('o')     1                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial
            2,   S.GUI.ProbCueAOmission,        1,    S.GUI.Delay,  S.GUI.OmissionValve, 	S.InterRew,    double('s')     1                   S.GUI.OptoStimCueDelay                    0;...   % CueA: omission
            3,   S.GUI.ProbCueBRwd,             2,    S.GUI.Delay,  S.GUI.RewardValve,      S.SmallRew,    double('o')     1                   S.GUI.OptoStimCueDelay                    0;...   
            4,   S.GUI.ProbCueBOmission,        2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.SmallRew,    double('s')     1                   S.GUI.OptoStimCueDelay                    0;...   % CueB: omission
            5,   S.GUI.ProbCueCOmission,        4,    S.GUI.Delay,  S.GUI.OmissionValve,    S.InterRew,    double('s')     1                   S.GUI.OptoStimCueDelay                    0;...   % CueC: omission
            6,   S.GUI.ProbUncuedRwd,           3,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,    double('o')     1                   S.GUI.OptoStimCueDelay                    0;...   % Uncued reward
            7,   S.GUI.ProbCueAOpto,            1,    S.GUI.Delay,  S.GUI.RewardValve,	    S.InterRew,    double('s')     3                   S.GUI.OptoStimCueDelay                    0;...   % (CueA+ Stim) + reward 
            8,   S.GUI.ProbCueBOpto,            2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.SmallRew,    double('s')     3                   S.GUI.OptoStimCueDelay                    0;...   % (CueB+ Stim) + omission 
            9,   S.GUI.ProbCueARwdOpto,         1,    S.GUI.Delay,  S.GUI.RewardValve,	    S.InterRew,    double('s')     1                   S.GUI.OptoStimCueDelay                    2;...   %  CueA  + (reward + stim)
            10,  S.GUI.ProbCueBOmissionOpto,    2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.SmallRew,    double('s')     1                   S.GUI.OptoStimCueDelay                    2;...    %  CueB  + (omission + stim)
            11,  S.GUI.ProbUncuedRwdOpto,       3,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,    double('o')     3                   S.GUI.OptoStimCueDelay                    0];
        easyTrials=[];
    ...
    case 'RewardB'
        ...
        trialsMatrix=[...
        % 1.type, 2.proba,                      3.sound, 4.delay,% 5.valve,                6.Outcome         	7.Marker    8. OptoStimCue     9. Delay OptoStimCue      10.OptoStimRwd
            1,   S.GUI.ProbCueAOmission,        1,    S.GUI.Delay,  S.GUI.OmissionValve,    S.InterRew,         double('s')  0                    0                    0;...   % CueA: big reward trial ;...   
            2,   S.GUI.ProbCueBRwd ,            2,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,         double('o')  0                    0                    0;...   % CueA: big reward trial;...   
            3,   S.GUI.ProbCueBOmission ,       2,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,         double('s')  0                    0                    0;...   % CueA: big reward trial;...   
            4,   S.GUI.ProbUncuedRwd,           3,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,         double('o')  0                    0                    0;...   % CueA: big reward trial;...    
            5,   S.GUI.ProbUncuedOmission,      3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,         double('s')  0                    0                    0;...   % CueA: big reward trial;...    
            6,   S.GUI.ProbBlank,               3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,         double('s')  0                    0                    0]    % CueA: big reward trial];
        easyTrials=[1 1 2 2 2 2 4 4];
    
    case 'RewardACBValues'
        trialsNames={'Cue A Reward','Cue A Omission',...
                     'Cue B Reward','Cue B Omission',...
                     'Cue C Reward','Cue C Omission','Uncued Reward'};
        trialsMatrix=[...
        % 1.type,       2.proba,                3.sound,    4.delay,    5.valve,                6.Outcome         	7.Marker
            1,    S.GUI.ProbCueARwd ,               1,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,        double('o')  0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial;...   
            2,    S.GUI.ProbCueAOmission ,          1,    S.GUI.Delay,  S.GUI.OmissionValve,    S.InterRew,        double('s')  0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial;...   
            3,    S.GUI.ProbCueBRwd,                4,    S.GUI.Delay,  S.GUI.RewardValve,      S.SmallRew,        double('o')  0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial;...   
            4,    S.GUI.ProbCueBOmission ,          4,    S.GUI.Delay,  S.GUI.OmissionValve,    S.SmallRew,        double('s')  0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial;...    
            5,    S.GUI.ProbCueCRwd ,               2,    S.GUI.Delay,  S.GUI.RewardValve,      S.LargeRew,        double('o')  0                   S.GUI.OptoStimCueDelay                    0;...   % CueA: big reward trial;...    
            6,    S.GUI.ProbCueCOmission,           2,    S.GUI.Delay,  S.GUI.OmissionValve,    S.LargeRew,        double('s')  0                   S.GUI.OptoStimCueDelay                    0;   % CueA: big reward trial];
            7,    S.GUI.ProbUncuedRwd,              3,    S.GUI.Delay,  S.GUI.RewardValve,      S.InterRew,     double('o')     0                   S.GUI.OptoStimCueDelay                    0];...   % Uncued reward
        easyTrials=[1 1 5 5 3 3];
end
