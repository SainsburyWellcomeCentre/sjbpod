function Value_Change_Two_Alternative_Choice_GUIParameters()
    ...
    % Fields
    S.GUIPanels.Specifics = { 'OriginalRewardsBlockLength', 'Contingency','ContingencyBlockLength',...
        'Muscimol','RewardProb'};
    ...
    S.GUI.OriginalRewardsBlockLength = 100;
