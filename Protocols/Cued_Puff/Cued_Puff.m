...
%"Cued_Puff_Phase": specify the phase of the training
...
S.SmallPuff  =   GetValveTimes(S.GUI.SmallPuff, S.GUI.RewardValve -1);
S.InterPuff  =   GetValveTimes(S.GUI.InterPuff, S.GUI.RewardValve-1);
S.LargePuff  =   GetValveTimes(S.GUI.LargePuff, S.GUI.RewardValve-1);
...
switch S.GUI.SoundType
    ...
    case 2
        CueA=SoundGenerator(S.GUI.SoundSamplingRate,S.GUI.LowFreq,S.GUI.FreqWidth,S.GUI.NbOfFreq,S.GUI.SoundDuration,S.GUI.SoundRamp, 0.003);
        CueB=SoundGenerator(S.GUI.SoundSamplingRate,S.GUI.HighFreq,S.GUI.FreqWidth,S.GUI.NbOfFreq,S.GUI.SoundDuration,S.GUI.SoundRamp, 0.003);
        NoCue=zeros(1,S.GUI.SoundDuration*S.GUI.SoundSamplingRate);
        if isfield(S.GUI,'CueC')
            CueC=SoundGenerator(S.GUI.SoundSamplingRate,S.GUI.CueC,S.GUI.FreqWidth,S.GUI.NbOfFreq,S.GUI.SoundDuration,S.GUI.SoundRamp, 0.003);
        else
            CueC=SoundGenerator(S.GUI.SoundSamplingRate,(S.GUI.LowFreq+S.GUI.HighFreq)/2,S.GUI.FreqWidth,S.GUI.NbOfFreq,S.GUI.SoundDuration,S.GUI.SoundRamp, 0.003);
        end
end
...
[S.TrialsNames, S.TrialsMatrix,ezTrialsSeq]=Cued_Puff_Phase(S,S.GUIMeta.Phase.String);
