function Cued_Puff_Task_Parameters()

global S %BpodSystem
    listPhases= {'PuffA','BigPuffASmallPuffB'} ;
    ...
    switch phaseName
         case 'PuffA'
            S.Names.Symbols={'Puff', 'Omission'};
        case 'BigPuffASmallPuffB'
            S.Names.Symbols={'Puff','Omission'};
    end
...
%% General Parameters    
    ...
    switch S.GUIMeta.Phase.String
        ...
        case 'PuffA'
            ...
            S.GUIPanels.TaskSpecifics = {'ProbCueAPuff',...
                'ProbCueAOmission',...
                'ProbCueBOmission','ProbUncuedPuff',...
        ...
        case 'BigPuffASmallPuffB'
            S.GUI.ProbCueAPuff = TrialSettings.ProbCueAPuff ;
            S.GUI.ProbCueAOmission = TrialSettings.ProbCueAOmission;
            S.GUI.ProbCueBPuff = TrialSettings.ProbCueBPuff ;
            S.GUI.ProbCueBOmission = TrialSettings.ProbCueBOmission ;
            S.GUI.ProbUncuedPuff = TrialSettings.ProbUncuedPuff ;
            S.GUI.ProbUncuedOmission = TrialSettings.ProbUncuedOmission;
            S.GUI.ProbCueAOpto = TrialSettings.ProbCueAOpto;
...
%% Task Parameters
    ...
    S.GUIMeta.AirValve.Style='popupmenu';
    S.GUIMeta.AirValve.String={0,1,2,3,4,5,6,7,8};

	S.GUIMeta.OmissionValve.Style='popupmenu';
    S.GUIMeta.OmissionValve.String={0,1,2,3,4,5,6,7,8};
    S.GUIPanels.Outcome={'AirValve','SmallPuff','LargePuff','OmissionValve'};
