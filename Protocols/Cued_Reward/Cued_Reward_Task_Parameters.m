function Cued_Reward_Task_Parameters()

global S %BpodSystem
    listPhases= {'RewardA','RewardARewardB','RwdAB_PunC'} ;
...
%% General Parameters    
    ...
    switch S.GUIMeta.Phase.String
        ...
        case 'RewardARewardB'
            ...
            S.GUI.ProbUncuedRwdOpto =TrialSettings.ProbUncuedRwdOpto;
                
            S.GUIPanels.TaskSpecifics = {'ProbCueARwd',...
                'ProbCueAOmission','ProbCueBRwd',...
                'ProbCueBOmission','ProbUncuedRwd',...
                'ProbUncuedOmission','ProbCueAOpto',...
                'ProbCueBOpto','ProbCueARwdOpto',...
                'ProbCueBOmissionOpto', 'ProbUncuedRwdOpto'};

        case 'RwdAB_PunC'
            S.GUIPanels.TaskSpecifics={...
                'ProbCueARwd','ProbCueAOmission',...
                'ProbCueBRwd','ProbCueBOmission',...
                'ProbCueCPunish','ProbCueCOmission',...
                'ProbUncuedRwd','ProbUncuedPunish'};     
    end
