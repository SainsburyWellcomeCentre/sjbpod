function Cued_Reward
%Functions used in this protocol:
%"Cued_Reward_Phase": specify the phase of the training
...
[S.TrialsNames, S.TrialsMatrix,ezTrialsSeq]=Cued_Reward_Phase(S,S.GUIMeta.Phase.String);
