...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
function UpdateOnlinePlotDirVectors(GUIdata,Data,SubjectName,TrialType,Action,Figurehandle)
% 
global BpodSystem
% CurrentTrial
i = BpodSystem.Data.nTrials;
    ...
    BpodSystem.Data.OnlinePlotParams.Secondstatetime(i) = Data.RawEvents.Trial{1, i}.States.Reward(1) - Data.RawEvents.Trial{1, i}.States.InitialPokeValve(1);
